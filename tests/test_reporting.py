...
def sample_ranked():
    return [{
        ...
        "rating_change": 0.0, "review_count_change": 2, "previous_rank": 2, "movement": 1,
    }]
...
def test_workbook_contains_research_sheets(tmp_path):
    ...
    expected = {"Top 50", "All Rankings", "Source Coverage", "Source Reliability", "Rating History", "New Entrants", "Biggest Movers", "QA Anomalies", "Duplicate Groups", "Methodology", "Chicken", "Potatoes", "Vegetables", "Desserts", "Beef", "Pork", "Seafood", "Breakfast", "Snacks"}
