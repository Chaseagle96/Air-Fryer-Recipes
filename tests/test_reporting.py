...
def sample_ranked():
    return [{
        ...
        "source_bias": 0.02, "category_expected_rating": 4.75, "adjusted_rating": 4.88, "posterior_mean": 4.85,
        "uncertainty_penalty": 0.1, "uncertainty_method": "theoretical_max_variance", "evidence_penalty": 0.0,
        "hierarchical_score": 4.75, "evidence_confidence": 1.0, "evidence_grade": "A",
        ...
        "rating_change": 0.0, "review_count_change": 2, "review_velocity_per_day": 48.0,
        "review_growth_7d": 20, "review_growth_30d": 60, "rating_trend_30d": 0.02,
        "peak_rank": 1, "rank_volatility": 0.5, "days_in_top10": 3, "days_in_top50": 3,
        "rank_confidence": 0.94, "rank_stddev": 0.4, "rank_range_low": 1, "rank_range_high": 3,
        "top10_frequency": 1.0, "top50_frequency": 1.0, "previous_rank": 2, "movement": 1,
...
def test_workbook_contains_research_sheets(tmp_path):
    ...
    write_workbook(
        path, sample_ranked(), [], [], [], [], [], {"formula": "test"},
        source_health=[], uncertainty_calibration=[], robustness=[], dedupe_benchmark=[],
    )
    wb = load_workbook(path, read_only=True)
    expected = {
        "Top 50", "All Rankings", "Rank Explainability", "Source Coverage", "Source Health",
        "Source Reliability", "Rating History", "Rating Trends", "Uncertainty Calibration",
        "Rank Robustness", "New Entrants", "Biggest Movers", "QA Anomalies", "Duplicate Groups",
        "Dedupe Benchmark", "Methodology", "Chicken", "Potatoes", "Vegetables", "Desserts",
        "Beef", "Pork", "Seafood", "Breakfast", "Snacks",
    }
