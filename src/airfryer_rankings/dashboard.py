...
<body>
<header><div><h1>Air Fryer Recipe Rankings</h1><div class="muted" id="generated">Loading…</div></div><div class="muted">Evidence-aware hierarchical Bayesian ranking with uncertainty and robustness</div></header>
<div class="controls">
...
<footer class="muted">Data is automatically refreshed from public recipe pages. Rankings are statistical estimates with explicit uncertainty, not taste-test judgments.</footer>
<script>
