...
def migrate_state(state: dict) -> dict:
    """Upgrade persisted state without silently preserving obsolete evidence assumptions."""
        ...
        observations.append(
            {
                ...
                "instruction_simhash": getattr(row, "instruction_simhash", ""),
                "image_fingerprint": row.image_fingerprint,
                "image_perceptual_hash": getattr(row, "image_perceptual_hash", ""),
